...
export const CustomColor = (): React.ReactElement => {
  return (
    <Tooltip title="Some text" backgroundColor="rinkeby" textColor="white" arrow>
      <span>hover me</span>
    </Tooltip>
  )
}
...
export const CustomColorAndArrow = (): React.ReactElement => {
  return (
    <Tooltip title="Some text" backgroundColor="primary" placement="left" textColor="white" arrow>
      <span>hover me</span>
    </Tooltip>
  )
}
